<x-app-layout title="Topups | Work Connect">
    ...
    <section class="p-4 mt-16 sm:ml-64">
        <div class="max-w-screen-xl px-4 lg:px-0">
            ...
            <h2 class="mb-3 text-2xl font-bold">Topups</h2>
            ...
            <div class="p-3 bg-white rounded-lg shadow-md">
                ...
                <table class="w-full text-sm text-left text-gray-500">
                    ...
                    @forelse ($topupTransactions as $topupTransaction)
                        <tr>
                                ...
                                <div class="flex items-center gap-x-2">
                                    ...
                                    <div>
                                        ...
                                        <span class="font-bold">
                                            Rp {{ number_format($topupTransaction->amount, 0, ',', '.') }}
                                        </span>
                                    </div>
                                </div>
                            </th>
                            ...
                            <th class="px-4 py-3 text-gray-900">
                                <div class="flex flex-col gap-x-2">
                                    ...
                                    <span class="font-bold">{{ $topupTransaction->user->name }}</span>
                                </div>
                            </th>
                            ...
                            <th class="px-4 py-3 text-gray-900">
                                <div class="flex flex-col gap-x-2">
                                    ...
                                    <span class="font-bold">{{ $topupTransaction->created_at->format('M d, Y') }}</span>
                                </div>
                            </th>
                            ...
                            <th class="px-4 py-3 text-gray-900">
                                <a href="{{ route('admin.transaction.show', $topupTransaction) }}"
                    ...
                    @empty
                        <td colspan="4" class="px-4 py-2 text-center">
                            No top-up transactions have been made yet.
                        </td>
                    @endforelse
                </table>
